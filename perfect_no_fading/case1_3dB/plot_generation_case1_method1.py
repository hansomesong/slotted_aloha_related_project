...
# sim_result_f_no = os.path.join(DATA_FOLDED, "simd=50000_N=500_threshold=3.0_l=1_m=1_backoff=100.csv")
...
sim_result_f_no = os.path.join(DATA_FOLDED, "simd=50000_N=500_threshold=3.0_l=1_m=1_backoff=150_start=0.2_end=1.05_simstep=0.02_093120.csv")
...
sim_result_f_more = os.path.join(
    DATA_FOLDED, "simd=50000_N=500_threshold=3.0_l=2_m=1_backoff=150_start=0.2_end=0.8_simstep=0.02_045109.csv"
)
...
sim_result_f_less = os.path.join(
    DATA_FOLDED,
    "simd=50000_N=400_threshold=3.0_l=1_m=2_backoff=150_start=0.24_end=0.9_simstep=0.02_065325.csv"
)
...
plt.savefig('logarithme_case1.eps', format='eps', dpi=300)
plt.show()
