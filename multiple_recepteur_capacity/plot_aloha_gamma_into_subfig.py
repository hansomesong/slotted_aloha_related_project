...
# 2018-04-19
# This is a fork from script: plot_aloha_gamma.py to draw all figures into one figure.
# Thus, only consider 3 different gammas in this script.
# for nomarlized load L, we only cover interval [0.1, 0.5] or []0.1, 0.4]
...
if __name__ == '__main__':
    ...
    lambda_b = 0.08
    lambda_m = np.linspace(0, X_END, 200)
    ...
    SIM_LOG_DIR = os.path.join(SIMULATOR_PATH, 'logs', 'SimuApril16')
    ...
    # Since this script is intended to draw every case into a same figure.
    # We only consider 3 different gammas
    gammas = [3.3, 4.0, 4.5]
    ...
    for i, gamma in enumerate(gammas):
        ...
        axes.set_yscale("log")
        axes.grid()
        axes.axis([X_START, L_END, Y_START, Y_END])
