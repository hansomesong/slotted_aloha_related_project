...
if __name__ == '__main__':
    ...
    SIM_SC_SHOW = False
    MRC_SHOW = False # Whether the curves about MRC should be present in the figure.
    SIM_MRC_SHOW = True
    FIT_MRC_SHOW = False # Whether the fitted curves about MRC should be present in the figure.
    SIM_FIT_MRC_SHOW = True # Whether the fitted curves about MRC should be present in the figure.
    ...
    # axes.set_yticks([5e-3, 1e-2, 5e-2, 1e-1, 1])

    locs = axes.yaxis.get_ticklocs()
    for loc in locs:
        print "loc", loc
    print type(locs)
