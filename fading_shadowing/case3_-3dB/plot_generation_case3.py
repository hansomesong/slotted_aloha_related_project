...
ana_result_f_no = os.path.join(DATA_FOLDED, "fading_shadowing_analytical_result_threshold=-3.0dB_l=1_m=1_sigma=1.csv")
# ana_result_f_more = os.path.join(DATA_FOLDED, "fading_shadowing_analytical_result_threshold=0dB_l=2_m=1_sigma=1.csv")
ana_result_f_less = os.path.join(DATA_FOLDED, "fading_shadowing_analytical_result_threshold=-3.0dB_l=1_m=2_sigma=1.csv")
