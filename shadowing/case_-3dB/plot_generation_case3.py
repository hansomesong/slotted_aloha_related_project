...
ana_result_f_no = os.path.join(DATA_FOLDED, "improved_cf_shadowing_analytical_result_threshold=-3.0dB_l=1_m=1_sigma=1.csv")
...
plt.savefig('logarithme_shadowing_case3.eps', format='eps', dpi=300)
plt.show()
