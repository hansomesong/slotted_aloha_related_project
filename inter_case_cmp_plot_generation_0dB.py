...
X_RANGE = [[0.4, 0.9], [0.4, 1.0], [0.4, 0.9]]
Y_RANGE = [[1e-3, 1.001], [0.3, 1.0], [0, 1.0], [1, 5]]
...
# axes[0].legend(handles[0:4:1], labels[0:4:1], loc='best', numpoints=1, fancybox=True, framealpha=0.5)
# axes[1].legend(handles[4:7:1], labels[4:7:1], loc='best', numpoints=1, fancybox=True, framealpha=0.5)
# axes[2].legend(handles[7::1], labels[7::1], loc='best', numpoints=1, fancybox=True, framealpha=0.5)
