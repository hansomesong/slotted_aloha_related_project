...
X_RANGE = [[0.6, 1.2], [0.7, 1.2], [0.6, 1.2]]
...
# axes[1].legend(handles[0:5:1], labels[0:5:1], loc='best', numpoints=1, fancybox=True, framealpha=0.5)
#
# handles, labels = axes[0].get_legend_handles_labels()
# axes[0].legend(handles[5::1], labels[5::1], loc='best', numpoints=1, fancybox=True, framealpha=0.5)
